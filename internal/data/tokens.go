...
// generateToken creates a new token with the given user ID, TTL, and scope
...
// ValidateTokenPlaintext checks that the plaintext token has been provided
...
// TokenModel wraps a database connection pool for token operations.
